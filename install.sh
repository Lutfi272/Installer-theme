...
installTheme(){
    ...
    git clone https://github.com/Lutfi272/installer-theme.git > /dev/null 2>&1
...
echo -e "${CYAN}=====================================${RESET}"
echo -e "${YELLOW}Creator By Crut L2F${RESET}"
}
...
repair(){
    bash <(curl https://raw.githubusercontent.com/Lutfi272/installer-theme/main/repair.sh)
}
